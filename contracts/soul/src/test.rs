...
fn test_recover_soul_success() {
    ...
    let recovery_pubkey = BytesN::from_array(&env, &[0x4, 0x8c, 0xf1, 0xa4, 0x2c, 0xd5, 0x2c, 0xe5, 0x71, 0x9f, 0x0, 0x36, 0xda, 0x37, 0x6a, 0x1b, 0x99, 0xf6, 0x10, 0x77, 0x4a, 0x10, 0x64, 0xb4, 0x5d, 0xa9, 0xef, 0xdf, 0x65, 0xa9, 0x67, 0x59, 0xa1, 0x14, 0x2e, 0xed, 0xf1, 0x85, 0x45, 0xfc, 0x77, 0x2d, 0x9b, 0xfb, 0x6e, 0x5e, 0x8, 0xc6, 0xa6, 0xa0, 0x4e, 0xd6, 0xac, 0xe0, 0x47, 0xc6, 0xa4, 0xcb, 0xbf, 0x46, 0x26, 0x95, 0x6a, 0xe, 0xb1]);

    let old_passkey = BytesN::from_array(&env, &[0u8; 65]);
    let new_passkey = BytesN::from_array(&env, &[1u8; 65]);

    let signature = BytesN::from_array(&env, &[0xd9, 0x9a, 0x85, 0x9b, 0x4f, 0x4a, 0x72, 0xb8, 0xb4, 0x25, 0xa1, 0x27, 0x97, 0x92, 0x47, 0x4d, 0x6, 0xa3, 0xaa, 0x27, 0x82, 0x92, 0xc0, 0x9c, 0xd, 0x64, 0x6c, 0x30, 0xb7, 0xe9, 0xdf, 0xbc, 0x7b, 0x58, 0x71, 0xfe, 0x3c, 0xec, 0x40, 0x16, 0x18, 0x53, 0x54, 0xb9, 0x64, 0xf, 0xbd, 0xae, 0xea, 0xe5, 0x9d, 0x5c, 0x63, 0x76, 0x59, 0x14, 0x4c, 0x15, 0xc2, 0xee, 0x43, 0xf6, 0xe9, 0x16]);
